...
function Content() {
    ...
    return (
        <Parallax pages={13} ref={ref}>
            ...
            {/* Foto Back */}
            <ParallaxLayer id='fotoBack' className='bg-image' offset={0} speed={1} sticky={{start: 0, end: 13}} style={{zIndex: -1}}>
                <div className="heroImage">
                    <img src={hero} alt="foto de Paul Yatim" className="img-fluid fixed-bottom"/>
                </div>
            </ParallaxLayer>
            {/* Foto Front */}
            <ParallaxLayer id='fotoFront' className='bg-image' offset={0} speed={1} sticky={{start: 0, end: 13}} style={{zIndex: 5}}>
                <div className="heroImage">
                    <img src={heroFront} alt="foto de Paul Yatim" className="img-fluid fixed-bottom"/>
                </div>
            </ParallaxLayer>
            {/* Intro */}
            <ParallaxLayer id='bienvenidxs' offset={1} speed={0.5} style={{zIndex: 1}}>
